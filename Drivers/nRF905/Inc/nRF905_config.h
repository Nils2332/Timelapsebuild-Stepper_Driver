...
// Payload size (1 - 32)
#define NRF905_PAYLOAD_SIZE	10 //NRF905_MAX_PAYLOAD
...
#define NRF905_TRX_EN	GPIO_PIN_2	// Enable/standby pin (Required)
#define NRF905_PWR_MODE	GPIO_PIN_3	// Power mode pin (Required)
#define NRF905_TX_EN	GPIO_PIN_4	// TX / RX mode pin (Required)
...
#define NRF905_CSN		PIN_1	// SPI slave select pin (Required)
